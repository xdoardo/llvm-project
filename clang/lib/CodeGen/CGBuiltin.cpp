...
static RValue EmitBinaryAtomicPost(CodeGenFunction &CGF,
  ...
  if (IsCheriCap) {
    ...
    Val = CGF.getCapabilityIntegerValue(Val);
  }
...
Value *MakeAtomicCmpXchgValue(CodeGenFunction &CGF, const CallExpr *E,
  ...
  if (!CGF.CGM.getDataLayout().isFatPointer(New->getType()))
...
RValue CodeGenFunction::EmitBuiltinExpr(const GlobalDecl GD, unsigned BuiltinID,
  ...
  case Builtin::BI__builtin_bcopy: {
    ...
    EmitNonNullArgCheck(RValue::get(Dest.emitRawPointer(*this)),
                        E->getArg(1)->getType(), E->getArg(1)->getExprLoc(), FD,
                        0);
    auto *I = Builder.CreateMemMove(Dest, Src, SizeVal, llvm::PreserveCheriTags::TODO, false);
    addInstToNewSourceAtom(I, nullptr);
    return RValue::get(nullptr);
  }
  ...
  case Builtin::BI__builtin_mempcpy: {
    ...
    auto I = Builder.CreateMemCpy(Dest, Src, SizeVal,
                                   llvm::PreserveCheriTags::TODO, false);
    diagnoseMisalignedCapabiliyCopyDest(*this, "memcpy", E->getArg(1), I);
    addInstToNewSourceAtom(I, nullptr);
    if (BuiltinID == Builtin::BImempcpy ||
      ...
      return RValue::get(Dest, *this, Dest.getAlignment().getQuantity());
  }
  ...
  case Builtin::BI__builtin___memmove_chk: {
    ...
    Address Src = EmitPointerWithAlignment(E->getArg(1));
    Value *SizeVal = llvm::ConstantInt::get(Builder.getContext(), Size);
    auto *I = Builder.CreateMemMove(Dest, Src, SizeVal,
                                    llvm::PreserveCheriTags::TODO, false);
    diagnoseMisalignedCapabiliyCopyDest(*this, "memmove", E->getArg(1), I);
    addInstToNewSourceAtom(I, nullptr);
    return RValue::get(Dest, *this, Dest.getAlignment().getQuantity());
  }
